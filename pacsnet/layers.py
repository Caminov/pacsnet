'''
Implementation of Switchable Normalization
Taken from https://github.com/switchablenorms/Switchable-Normalization/blob/master/devkit/ops/switchable_norm.py
'''
